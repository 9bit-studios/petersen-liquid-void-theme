...
**Platform Tracking:**
- Platform (Select: Instagram, Twitter, TikTok, YouTube, Facebook, LinkedIn)
...
```mermaid
graph LR
    A[Instagram API] --> E[Analytics Hub]
    B[YouTube Analytics] --> E
    C[Twitter API] --> E
    D[TikTok Analytics] --> E
    E --> F[Grid Calculations]
    E --> G[Klaviyo Segments]
    F --> H[Notion Dashboard]
    G --> H
    H --> I[Arthur's Command Center]
```
