...
class PriorityFoundationIntegrator {
  constructor() {
    this.baseDir = path.join(process.env.OKSANA_ROOT || '/Users/pennyplatt/9BitStudios/Oksana', 'quantum-spatial/petersen-liquid-void-theme/petersen-liquid-glass-void-theme');
