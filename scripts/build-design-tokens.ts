...
class PetersenGamesTokenBuilder {
  ...
  private async loadQuantumSpatialTokens() {
  ...
  private async generateCSSVariables() {
  ...
  private async generateLiquidIncludes() {
  ...
  private async generateTypeScriptDefinitions() {
